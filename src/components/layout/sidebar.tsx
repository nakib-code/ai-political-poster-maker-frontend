    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-white/10 px-5">
          ...
          >
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-500 text-sm font-black text-slate-950">
              AI
            </span>
        ...
        <div className="shrink-0 border-t border-white/10 p-4">
          <div className="card-soft border-emerald-500/10 bg-emerald-500/[0.04] p-3.5">
